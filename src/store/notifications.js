...
// Action types
const ADD_NOTIFICATION = 'reapop/ADD_NOTIFICATION';
const UPDATE_NOTIFICATION = 'reapop/UPDATE_NOTIFICATION';
const REMOVE_NOTIFICATION = 'reapop/REMOVE_NOTIFICATION';
const REMOVE_NOTIFICATIONS = 'reapop/REMOVE_NOTIFICATIONS';
